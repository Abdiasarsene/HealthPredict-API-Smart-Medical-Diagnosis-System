# app/deployments/treatment_deployment.py
import sys
import logging
...
# ====== RAY SERVE TREATMENT MODEL ======
class TreatmentDeployment:
    try:
        @serve.deployment
        class Treatment:
            ...
            async def __call__(self, input_dict: dict):
                try:
                    ...
                    return {"Error": "Treatment timed out"}
        
        @classmethod
        def deploy(cls, model, model_type):
            return cls.Treatment.bind(model, model_type)
